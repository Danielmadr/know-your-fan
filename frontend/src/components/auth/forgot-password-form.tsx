      ...
      <div className="flex w-full lg:w-1/2 flex-col justify-center items-center bg-background dark:bg-zinc-900 px-4">
        <div className="w-full max-w-md">
          <div className="mb-8 text-center">
            ...
            />
            <h1 className="text-3xl font-bold text-foreground dark:text-white">Recuperar Senha</h1>
            <p className="text-muted-foreground dark:text-gray-400 mt-2">Enviaremos instruções para seu e-mail</p>
          </div>
        ...
        <div className="h-full w-full bg-[url('/bg-login.jpg')] bg-cover bg-center relative">
          ...
          <div className="absolute bottom-0 left-0 p-12 text-white max-w-lg">
            ...
            <p className="text-lg opacity-80">
              Sem problemas! Acontece com todo mundo. 
              Vamos ajudar você a recuperar seu acesso e voltar 
              a torcer com a FURIA.
            </p>
          </div>
        </div>
      </div>
